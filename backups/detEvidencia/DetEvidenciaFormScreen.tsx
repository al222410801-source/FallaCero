...
type LocalDenuncia = { ciudadano_id?: number; titulo?: string; fecha_denuncia?: string; categoria?: string; prioridad?: string; seguimiento_id?: number };
...
export default function DetEvidenciaFormScreen({navigation, route}: Props) {
  ...
  const [localDen, setLocalDen] = useState<LocalDenuncia>({ciudadano_id: undefined, titulo: '', fecha_denuncia: undefined, categoria: '', prioridad: '', seguimiento_id: undefined});
    ...
    try {
      ...
      if (!denunciaId && localDen.titulo && localDen.ciudadano_id) {
        const denPayload: any = {
          ...
          seguimiento_id: localDen.seguimiento_id ? Number(localDen.seguimiento_id) : 0,
