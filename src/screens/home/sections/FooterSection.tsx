  ...
  return (
    <View style={[styles.footer, {backgroundColor: C.bg, borderTopColor: C.border}]}>
      ...
      <View style={styles.brand}>
        ...
        <View style={{flex: 1}}>
          <Text style={[styles.brandName, {color: C.textMain}]}>FallaCero</Text>
          <Text style={[styles.brandDesc, {color: C.textSub}]}>Reporte ciudadano y seguimiento de fallas en infraestructura pública.</Text>
        </View>
      </View>
