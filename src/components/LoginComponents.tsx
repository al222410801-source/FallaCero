...
// Use theme colors from global palette via hooks inside components
  ...
  return (
    <View style={{alignItems: 'center', gap: 6}}>
      <View style={{
        ...
        backgroundColor: C.accentAlt ? C.accentAlt + '12' : 'rgba(56,189,248,0.1)',
        borderWidth: 1.5, borderColor: C.accentAlt ? C.accentAlt + '22' : 'rgba(56,189,248,0.22)',
        alignItems: 'center', justifyContent: 'center',
        shadowColor: C.primary, shadowOpacity: 0.25, shadowRadius: 22,
        marginBottom: 4,
      }}>
        <Text style={{fontSize: 26}}>🏛️</Text>
      </View>
      <Text style={{
        fontSize: 26, fontWeight: '900', color: C.primary, letterSpacing: -0.5,
        textShadowColor: C.accentAlt ? C.accentAlt + '44' : 'rgba(56,189,248,0.4)', textShadowRadius: 12,
    ...
    <View style={{alignItems: 'center', justifyContent: 'center', minHeight: 280, flex: 1}}>
      <View style={{width: 260, height: 340, alignItems: 'center', justifyContent: 'center'}}>
        ...
        <Animated.View style={{alignItems: 'center', justifyContent: 'center', zIndex: 10, transform: [{translateY: floatAnim}]}}>
          <Image source={require('../../assets/capibara.png')} style={{width: 250, height: 250}} />
        </Animated.View>
